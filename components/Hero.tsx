...
const Hero: React.FC = () => {
  return (
    <section id="inicio" className="relative h-screen w-full flex items-center justify-center overflow-hidden scroll-mt-28">
      {/* Background Overlay */}
      ...
      <div className="relative z-20 container mx-auto px-4 text-center text-white mt-16">
        <div className="inline-block bg-amber-500/20 border border-amber-500/50 backdrop-blur-sm px-4 py-1 rounded-full mb-6 animate-fade-in-up">
            <span className="text-amber-400 font-semibold tracking-wide text-sm uppercase">Especialista em Edificações</span>
        </div>

        <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold leading-tight mb-6 max-w-5xl mx-auto drop-shadow-xl animate-fade-in-up delay-100">
          Tire sua Obra do Papel com <span className="text-amber-500">Segurança Técnica</span> e Visualize Tudo Antes de Construir.
        </h1>

        <p className="text-lg md:text-2xl text-gray-200 mb-10 max-w-3xl mx-auto font-light animate-fade-in-up delay-200">
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center items-center animate-fade-in-up delay-300">
          <a
            href="#contato"
            className="bg-amber-500 hover:bg-amber-600 text-white text-lg font-bold px-8 py-4 rounded-lg shadow-lg shadow-amber-500/30 transition-all transform hover:scale-105 flex items-center gap-2 group"
          >
